...
public class Util {
    ...
    public static void showToast(String txt){
        if (toast==null) {
            toast = Toast.makeText(MyApplication.getContext(), txt, Toast.LENGTH_SHORT);
        } else{
            toast.setText(txt);
        }
        toast.show();
    ...
    public static void showToastLong(String txt){
        if (toast==null) {
            toast = Toast.makeText(MyApplication.getContext(), txt, Toast.LENGTH_LONG);
        } else{
            toast.setText(txt);
        }
        toast.show();
